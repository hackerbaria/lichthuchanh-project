...
namespace Presentation_Layer
{
    public partial class FormXemLich : Form {
        ...
        private void FormXemLich_Load(object sender, EventArgs e)
        {
            ...
            dt = lapLichBUS.getLichByWeek(1);

            DataTable dt2 = new DataTable();
            dt2 = lapLichBUS.getLichByWeek(2);

            DataTable dt3 = new DataTable();
            dt3 = lapLichBUS.getLichByWeek(3);

            DataTable dt4 = new DataTable();
            dt4 = lapLichBUS.getLichByWeek(4);

            DataTable dt5 = new DataTable();
            dt5 = lapLichBUS.getLichByWeek(5);

            DataTable dt6 = new DataTable();
            dt6 = lapLichBUS.getLichByWeek(6);

            DataTable dt7 = new DataTable();
            dt7 = lapLichBUS.getLichByWeek(7);

            DataTable dt8 = new DataTable();
            dt8 = lapLichBUS.getLichByWeek(8);

            DataTable dt9 = new DataTable();
            dt9 = lapLichBUS.getLichByWeek(9);

            DataTable dt10 = new DataTable();
            dt10 = lapLichBUS.getLichByWeek(10);

            DataTable dt11 = new DataTable();
            dt11 = lapLichBUS.getLichByWeek(11);

            DataTable dt12 = new DataTable();
            dt12 = lapLichBUS.getLichByWeek(12);

            DataTable dt13 = new DataTable();
            dt13 = lapLichBUS.getLichByWeek(13);

            DataTable dt14 = new DataTable();
            dt14 = lapLichBUS.getLichByWeek(14);

            DataTable dt15 = new DataTable();
            dt15 = lapLichBUS.getLichByWeek(15);
            ...
            for (int i = 0; i < dt2.Rows.Count; i++)
            {
                ...
                String Value = dt2.Rows[i][0] +" " + dtMon.Rows[0][1] + " " + dt2.Rows[i][2] + " (" + dt2.Rows[i][7] + ")";
            ...
            for (int i = 0; i < dt3.Rows.Count; i++)
            {
                ...
                String Value = dt3.Rows[i][0] + " " + dtMon.Rows[0][1] + " " + dt3.Rows[i][2] + " (" + dt3.Rows[i][7] + ")";
            ...
            for (int i = 0; i < dt4.Rows.Count; i++)
            {
                ...
                String Value = dt4.Rows[i][0] + " " + dtMon.Rows[0][1] + " " + dt4.Rows[i][2] + " (" + dt4.Rows[i][7] + ")";
            ...
            for (int i = 0; i < dt5.Rows.Count; i++)
            {
                ...
                String Value = dt5.Rows[i][0] + " " + dtMon.Rows[0][1] + " " + dt5.Rows[i][2] + " (" + dt5.Rows[i][7] + ")";
            ...
            for (int i = 0; i < dt6.Rows.Count; i++)
            {
                ...
                String Value = dt6.Rows[i][0] + " " + dtMon.Rows[0][1] + " " + dt6.Rows[i][2] + " (" + dt6.Rows[i][7] + ")";
            ...
            for (int i = 0; i < dt7.Rows.Count; i++)
            {
                ...
                String Value = dt7.Rows[i][0] + " " + dtMon.Rows[0][1] + " " + dt7.Rows[i][2] + " (" + dt7.Rows[i][7] + ")";
            ...
            for (int i = 0; i < dt8.Rows.Count; i++)
            {
                ...
                String Value = dt8.Rows[i][0] + " " + dtMon.Rows[0][1] + " " + dt8.Rows[i][2] + " (" + dt8.Rows[i][7] + ")";
            ...
            for (int i = 0; i < dt9.Rows.Count; i++)
            {
                ...
                String Value = dt9.Rows[i][0] + " " + dtMon.Rows[0][1] + " " + dt9.Rows[i][2] + " (" + dt9.Rows[i][7] + ")";
            ...
            for (int i = 0; i < dt10.Rows.Count; i++)
            {
                ...
                String Value = dt10.Rows[i][0] + " " + dtMon.Rows[0][1] + " " + dt10.Rows[i][2] + " (" + dt10.Rows[i][7] + ")";
            ...
            for (int i = 0; i < dt11.Rows.Count; i++)
            {
                ...
                String Value = dt11.Rows[i][0] + " " + dtMon.Rows[0][1] + " " + dt11.Rows[i][2] + " (" + dt11.Rows[i][7] + ")";
            ...
            for (int i = 0; i < dt12.Rows.Count; i++)
            {
                ...
                String Value = dt12.Rows[i][0] + "" + dtMon.Rows[0][1] + " " + dt12.Rows[i][2] + " (" + dt12.Rows[i][7] + ")";
            ...
            for (int i = 0; i < dt13.Rows.Count; i++)
            {
                ...
                String Value = dt13.Rows[i][0] + " " + dtMon.Rows[0][1] + " " + dt13.Rows[i][2] + " (" + dt13.Rows[i][7] + ")";
            ...
            for (int i = 0; i < dt14.Rows.Count; i++)
            {
                ...
                String Value = dt14.Rows[i][0] + " " + dtMon.Rows[0][1] + " " + dt14.Rows[i][2] + " (" + dt14.Rows[i][7] + ")";
                String number = dt.Rows[i][6].ToString();
            ...
            for (int i = 0; i < dt15.Rows.Count; i++)
            {
                ...
                String Value = dt15.Rows[i][0] + " " + dtMon.Rows[0][1] + " " + dt15.Rows[i][2] + " (" + dt15.Rows[i][7] + ")";
