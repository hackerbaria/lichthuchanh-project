...
{
    public partial class UCXemLichGiaoVien : UserControl
    {
        ...
        public UCXemLichGiaoVien()
        {
            InitializeComponent();
        }

        private void UCXemLichGiaoVien_Load(object sender, EventArgs e)
        {
            ...
            foreach (DataGridView dgv in listDGV)
            {
                ...
                dt = lapLichBUS.getLichByMaGVAndWeek(Utils.Acount, week);
                ...
                for (int i = 0; i < dt.Rows.Count; i++)
                {
                    ...
                    // dinh dang cua dau ra: TenMonHoc-TenLop (tietbatdau-tietketthuc)
                    String Value = tenMH + "-" + tenlop + " (" + dt.Rows[i][7] + ")";
        ...
        private void tabTuan1_Paint(object sender, PaintEventArgs e)
        {

        }

        private void dgvTuan2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
