...
namespace Presentation_Layer
{
    public partial class UCGiaoVien : UserControl
    {
        ...
        {
            loadGV();
            this.txtMaGV.Text = DGVGiaoVien.Rows[0].Cells[0].Value.ToString();
            this.txtTenGV.Text = DGVGiaoVien.Rows[0].Cells[1].Value.ToString();
            this.txtDiaChi.Text = DGVGiaoVien.Rows[0].Cells[2].Value.ToString();
            this.txtSoDienThoai.Text = DGVGiaoVien.Rows[0].Cells[3].Value.ToString();
        }
